// 1. Создайте интерфейс IPerson, абстрактный класс Employee, который реализует интерфейс IPerson, и конкретные классы Manager и Developer.
...
abstract class Employee implements IPerson {
    ...
    protected abstract calculatedSalary(): void;

    getDetails(): string {
        return `My name is ${this.name} ${this.surname}, I have ${this.experienceYears} years of experience and ${this.salary} salary`;
    }
}
...
class Manager extends Employee {
    ...
    protected calculatedSalary(): void {
        this.salary = this.experienceYears * 500;
    }
    getDetails(): string {
        return `My name is ${this.name} ${this.surname}, I'm a manager with ${this.experienceYears} years of experience specializing in ${this.prefered} and ${this.salary} salary`;
    }
}
...
class Developer extends Employee {
    ...
    getDetails(): string {
        return `My name is ${this.name} ${this.surname}, I'm a software developer with ${this.experienceYears} years of experience in ${this.programmingLanguage} and ${this.salary} salary`;
    }
}

const manager = new Manager('Alex', 'Born', 5, 'scrum');
